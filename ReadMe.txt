...
----------------------
Saranya Chithalandur Rajedran (aj2727)
Keerthana Mahalingam(jj4496)							
...
---------------------------
1. Extract the GoBackN-Source zip file
2. The extracted GoBackN-Source directory must contain the below three files
	 i) start.html
	 ii) app.js
	 iii) app.css
